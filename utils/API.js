...
export default {
  handleLogin: function (accessToken) {
    return axios.get(`https://trek-tips.herokuapp.com/api/tips/${accessToken}`)
  },
  searchYelp: function(id, location, categories) {
    return axios.post(`https://trek-tips.herokuapp.com/api/user/${id}/recommendations/`, {location, categories})
  },
  // get all users
  getAllUsers: function() {
    return axios.get(`https://trek-tips.herokuapp.com/api/user`)
  },
  // create new user
  createUser: function() {
    return axios.post(`https://trek-tips.herokuapp.com/api/user/new`)
  },
  // find user by id and populate with preferences
  findUserById: function(id) {
    return axios.get(`https://trek-tips.herokuapp.com/api/user/${id}`)
  },
  // add user preference
  addUserPreference: function(id, categoryid) {
    return axios.post(`https://trek-tips.herokuapp.com/api/user/${id}/category/${categoryid}`)
  },
  // delete user preference
  removeUserPreference: function(id, categoryid) {
    return axios.delete(`https://trek-tips.herokuapp.com/api/user/${id}/category/${categoryid}`)
  },
  // get saved places and populate with place data
  getUserSavedPlaces: function(id) {
    return axios.get(`https://trek-tips.herokuapp.com/api/user/${id}/places/saved`)
  },
  // save a place to a user's record (and add it to the places collection if new)
  addUserSavedPlace: function(id, placeObject) {
    return axios.get(`https://trek-tips.herokuapp.com/api/user/${id}/places/saved/`, { placeObject })
  },
  // remove saved place
  removeUserSavedPlace: function(id, placeid) {
    return axios.get(`https://trek-tips.herokuapp.com/api/user/${id}/places/saved/${placeid}`)
  },
  // get visited places
  getUserVisitedPlaces: function(id) {
    return axios.get(`https://trek-tips.herokuapp.com/api/user/${id}/places/visited`)
  },
  ...
  addUserVisitedPlace: function(id, placeObject) {
    return axios.get(`https://trek-tips.herokuapp.com/api/user/${id}/places/visited/`, { placeObject })
  },
  // remove visited place
  removeUserVisitedPlace: function(id, placeid) {
    return axios.get(`https://trek-tips.herokuapp.com/api/user/${id}/places/visited/${placeid}`)
  },
  // delete place from place collection -- for cleaning collection during testing
  deletePlace: function(id) {
    return axios.put(`https://trek-tips.herokuapp.com/api/place/${id}`)
  },
  getAllUserPlaces: function(id) {
    return axios.get(`https://trek-tips.herokuapp.com/api/user/${id}/places`)
  },
